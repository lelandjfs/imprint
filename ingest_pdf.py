...
def get_imprint_pdfs():
    ...
    results = drive.files().list(
        q=f"'{IMPRINT_FOLDER_ID}' in parents and mimeType='application/pdf'",
...
- entities: Array of companies/people mentioned. Use tickers for public companies (NVDA not Nvidia), canonical names for private (OpenAI not openai). Include people's names if they are central to the document.
