...
import anthropic
import psycopg2
from imprint_utils import log_ingestion, document_exists, get_google_credentials
...
Given the document below (extracted from a visual/chart-heavy PDF), propose tags following the Imprint taxonomy.
