...
rag_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "1. NEVER invent, fabricate, or hallucinate document titles or content\n"
            "2. ONLY analyze documents explicitly provided in the Context section below\n"
            "3. If you see fewer documents than expected, analyze ONLY what is provided\n"
            "4. If no relevant documents are provided, respond: 'No documents found for this query.'\n"
            "5. Each DOCUMENT title MUST exactly match a title from the Context section\n"
            "6. Each EXCERPT MUST be a direct quote from the Context section\n"
            "\n\n"
            "Use this clean, structured format with each section on a NEW LINE:\n\n"
            "DOCUMENT: [Exact title from context]\n\n"
            "KEY INSIGHT:\n"
            "[2-3 sentence summary]\n\n"
            "EXCERPT:\n"
            "[Direct quote from context]\n\n"
            "THESIS USE:\n"
            "[How this supports bullish/bearish thesis]\n\n"
            "---\n\n"
            "[Repeat for ONLY the documents in context]\n\n"
            "Formatting Rules:\n"
            "- DO NOT use markdown symbols (no #, *, -, etc.)\n"
            "- Put CAPS labels on their own line, content below\n"
